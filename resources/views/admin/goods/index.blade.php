    ...
    <div class="mws-panel grid_8">
        ...
        <div class="mws-panel grid_8">
          <div class="mws-panel-header">
            <span>
              <i class="icon-windows"></i>商品列表</span>
          </div>
              ...
              <table class="mws-datatable mws-table dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                <thead>
                  <tr role="row">
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 193px;" aria-label="Browser: activate to sort column ascending">商品名称</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 179px;" aria-label="Platform(s): activate to sort column ascending">商品价格</th>
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    @foreach($goods as $k=>$v)
                      <tr class="@if($k%2==1) odd @else even @endif">
                        ...
                        <td class=" ">{{$v->price}}</td>
                        <td class=" ">
                            <input uid="{{$v->id}}" class="ibutton" type="checkbox" data-label-on="上架" data-label-off="下架" @if($v->status == '1') checked="checked"  @endif>
                        </td>
                        <td class=" ">
                            <a class="btn btn-info icon-pencil" href="/goods/edit?id={{$v->id}}"></a>
                            <a class="btn btn-danger icon-trash" href="/goods/delete?id={{$v->id}}"></a>
                        </td>
                      </tr>
                    @endforeach
                </tbody>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('.ibutton-container').click(function(){
                ...
                //发送ajax请求
                $.post('/goods/aupdate',{'status':status,'id':id},function(data){
                    if(data == 1){
                        success('更新成功');
                    }else{
                        error('更新失败');
